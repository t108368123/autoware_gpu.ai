...
///////////////////////////////
Eigen::Matrix4f t_localizer_rgb(Eigen::Matrix4f::Identity()); 
...
static void points_callback(const sensor_msgs::PointCloud2::ConstPtr& input)
{
  ...
  t_localizer_rgb = t_localizer; //yuan add
...
int main(int argc, char** argv)
{
  ...
  ndt_map_rgb_pub = nh.advertise<sensor_msgs::PointCloud2>("/ndt_rgb_map", 1000);
  ...
  ros::Subscriber points_rgb_sub = nh.subscribe("points_fused", 100000, points_rgb_callback);
